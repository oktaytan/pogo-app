<template>
  <div style="postion: relative">
    ...
    <a-card
      ...
      :style="{
        height: GET_TOP_BAR_SHOW ? '73vh' : '80vh',
      ...
      <div class="post_detail">
        <div class="post_detail_header">
          ...
          <a-avatar
            ...
            >{{ GET_POST_BY_ID.author.username | userAvatar }}</a-avatar
          >
          <div>
            <div>
            ...
            >
              {{ GET_POST_BY_ID.title }}
            </p>
          </div>
        </div>
        <!-- Gönderi gövdesi -->
        <div
          class="post_detail_content"
          :style="{
            color: GET_THEME
              ? GET_COLORS.dark.textPrimary
              : GET_COLORS.light.textPrimary
            ...
            >
              <a-comment>
                ...
                <a-avatar
                  ...
                  >{{ item.author.username | userAvatar }}</a-avatar
                >
                <!-- Yorumun içeriği -->
                <p
                  slot="content"
